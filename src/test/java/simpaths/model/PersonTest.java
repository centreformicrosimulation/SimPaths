...
public class PersonTest {
    ...
    // Education tests
    // Main steps:
    //  1) set up static mocks and constructor stubs
    //  2) create Person and inject model/innovations/benefit unit
    //  3) run inSchool()/setEducationLevel()/leavingSchool() and assert state transitions
    // =====================================================================
