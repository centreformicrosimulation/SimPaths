...
public class Parameters {
    ...
    public static double labour_innovation_employment_persistence_probability = 0.8;
    public static double labour_innovation_notinemployment_persistence_probability = 0.8;
    ...
    private static int MAX_START_YEAR = 2015; //Maximum allowed starting point. Should correspond to the most recent initial population.
...
//					maleMinAgeSick = age;
        ...
        */
        ...
        loadLabourSupplyUtilityParameters(countryString, labourSupplyExcelFileName);
        ...
        loadHealthMentalParameters(countryString, healthMentalExcelFileName);


        loadHealthWellbeingParameters(countryString, healthWellbeingExcelFileName);
...
//        coeffCovarianceDLS1 = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "reg_lifesatisfaction.xlsx", countryString + "_DLS1", 1, columnsLifeSatisfaction1);
    ...
    public static void updateCountryColumnNumbers(Country country) {
        ...
        if(country.equals(Country.IT)) {
            columnsWagesMales = columnsWagesMales == -1? 11: columnsWagesMales ;
            columnsWagesFemales = columnsWagesFemales == -1? 11: columnsWagesFemales ;
            columnsEmploymentSelectionMales = columnsEmploymentSelectionMales == -1? 14: columnsEmploymentSelectionMales ;
            columnsEmploymentSelectionFemales = columnsEmploymentSelectionFemales == -1? 14: columnsEmploymentSelectionFemales ;
            columnsLabourSupplyUtilityMales = columnsLabourSupplyUtilityMales == -1? 11: columnsLabourSupplyUtilityMales ;
            columnsLabourSupplyUtilityFemales = columnsLabourSupplyUtilityFemales == -1? 11: columnsLabourSupplyUtilityFemales ;
            columnsLabourSupplyUtilityMalesWithDependent = columnsLabourSupplyUtilityMalesWithDependent == -1? 10: columnsLabourSupplyUtilityMalesWithDependent ;
            columnsLabourSupplyUtilityFemalesWithDependent = columnsLabourSupplyUtilityFemalesWithDependent == -1? 9: columnsLabourSupplyUtilityFemalesWithDependent ;
            columnsLabourSupplyUtilityACMales = columnsLabourSupplyUtilityACMales == -1? 12: columnsLabourSupplyUtilityACMales ;
            columnsLabourSupplyUtilityACFemales = columnsLabourSupplyUtilityACFemales == -1? 9: columnsLabourSupplyUtilityACFemales ;
            columnsLabourSupplyUtilityCouples = columnsLabourSupplyUtilityCouples == -1? 17: columnsLabourSupplyUtilityCouples ;
            columnsHealthH1a = columnsHealthH1a == -1? 15 : columnsHealthH1a; //1 for coeffs + 15 for var-cov matri: x
            columnsHealthH1b = columnsHealthH1b == -1? 22: columnsHealthH1b ;
            columnsHealthH2b = columnsHealthH2b == -1? 24: columnsHealthH2b ;
            columnsHealthHM1 = columnsHealthHM1 == -1? 6: columnsHealthHM1 ;
            columnsHealthHM2Males = columnsHealthHM2Males == -1? 9: columnsHealthHM2Males ;
            columnsHealthHM2Females = columnsHealthHM2Females == -1? 9: columnsHealthHM2Females ;
            columnsEducationE1a = columnsEducationE1a == -1? 14: columnsEducationE1a ;
            columnsEducationE1b = columnsEducationE1b == -1? 19: columnsEducationE1b ;
            columnsEducationE2a = columnsEducationE2a == -1? 22: columnsEducationE2a ;
            columnsPartnershipU1 = columnsPartnershipU1 == -1? 21: columnsPartnershipU1 ;
            columnsPartnershipU2 = columnsPartnershipU2 == -1? 27: columnsPartnershipU2 ;
            columnsFertilityF1 = columnsFertilityF1 == -1? 22: columnsFertilityF1 ;
            columnsIncomeI1a = columnsIncomeI1a == -1? 13: columnsIncomeI1a ;
            columnsIncomeI1b = columnsIncomeI1b == -1? 22: columnsIncomeI1b ;
            columnsIncomeI3a = columnsIncomeI3a == -1? 13: columnsIncomeI3a ;
            columnsIncomeI3b = columnsIncomeI3b == -1? 22: columnsIncomeI3b ;
            columnsIncomeI3c = columnsIncomeI3c == -1? 23: columnsIncomeI3c ;
            columnsIncomeI3a_selection = columnsIncomeI3a_selection == -1? 13: columnsIncomeI3a_selection ;
            columnsIncomeI3b_selection = columnsIncomeI3b_selection == -1? 22: columnsIncomeI3b_selection ;
            columnsLeaveHomeP1a = columnsLeaveHomeP1a == -1? 19: columnsLeaveHomeP1a ;
            columnsHomeownership = columnsHomeownership == -1? 32: columnsHomeownership ;
            columnsRetirementR1a = columnsRetirementR1a == -1? 19: columnsRetirementR1a ;
            columnsRetirementR1b = columnsRetirementR1b == -1? 24: columnsRetirementR1b ;
            columnsChildcareC1a = columnsChildcareC1a == -1? 37: columnsChildcareC1a ;
            columnsChildcareC1b = columnsChildcareC1b == -1? 37: columnsChildcareC1b ;
            columnsValidationStudentsByAge = columnsValidationStudentsByAge == -1? 10: columnsValidationStudentsByAge ;
            columnsValidationStudentsByRegion = columnsValidationStudentsByRegion == -1? 6: columnsValidationStudentsByRegion ;
            columnsValidationEducationLevel = columnsValidationEducationLevel == -1? 3: columnsValidationEducationLevel ;
            columnsValidationEducationLevelByAge = columnsValidationEducationLevelByAge == -1? 24: columnsValidationEducationLevelByAge ;
            columnsValidationEducationLevelByRegion = columnsValidationEducationLevelByRegion == -1? 15: columnsValidationEducationLevelByRegion ;
            columnsValidationPartneredBUShareByRegion = columnsValidationPartneredBUShareByRegion == -1? 6: columnsValidationPartneredBUShareByRegion ;
            columnsValidationDisabledByGender = columnsValidationDisabledByGender == -1? 6: columnsValidationDisabledByGender ;
            columnsValidationDisabledByAgeGroup = columnsValidationDisabledByAgeGroup == -1? 2: columnsValidationDisabledByAgeGroup ;
            columnsValidationHealthByAgeGroup = columnsValidationHealthByAgeGroup == -1? 6: columnsValidationHealthByAgeGroup ;
            columnsValidationEmploymentByGender = columnsValidationEmploymentByGender == -1? 2: columnsValidationEmploymentByGender ;
            columnsValidationEmploymentByGenderAndAge = columnsValidationEmploymentByGenderAndAge == -1? 18: columnsValidationEmploymentByGenderAndAge ;
            columnsValidationEmploymentByMaternity = columnsValidationEmploymentByMaternity == -1? 3: columnsValidationEmploymentByMaternity ;
            columnsValidationEmploymentByGenderAndRegion = columnsValidationEmploymentByGenderAndRegion == -1? 10: columnsValidationEmploymentByGenderAndRegion ;
            columnsValidationActivityStatus = columnsValidationActivityStatus == -1? 3: columnsValidationActivityStatus ;
            columnsValidationLabourSupplyByEducation = columnsValidationLabourSupplyByEducation == -1? 3: columnsValidationLabourSupplyByEducation ;
        }
        else if(country.equals(Country.UK)) {
            columnsWagesMalesNE = columnsWagesMalesNE == -1? 30: columnsWagesMalesNE ;
            columnsWagesMalesE = columnsWagesMalesE == -1? 31: columnsWagesMalesE ;
            columnsWagesFemalesNE = columnsWagesFemalesNE == -1? 30: columnsWagesFemalesNE ;
            columnsWagesFemalesE = columnsWagesFemalesE == -1? 31: columnsWagesFemalesE ;
            columnsEmploymentSelectionMalesNE = columnsEmploymentSelectionMalesNE == -1? 30: columnsEmploymentSelectionMalesNE ;
            columnsEmploymentSelectionMalesE = columnsEmploymentSelectionMalesE == -1? 29: columnsEmploymentSelectionMalesE ;
            columnsEmploymentSelectionFemalesNE = columnsEmploymentSelectionFemalesNE == -1? 30: columnsEmploymentSelectionFemalesNE ;
            columnsEmploymentSelectionFemalesE = columnsEmploymentSelectionFemalesE == -1? 29: columnsEmploymentSelectionFemalesE ;
            columnsLabourSupplyUtilityMales = columnsLabourSupplyUtilityMales == -1? 8: columnsLabourSupplyUtilityMales ;
            columnsLabourSupplyUtilityFemales = columnsLabourSupplyUtilityFemales == -1? 107: columnsLabourSupplyUtilityFemales ;
            columnsLabourSupplyUtilityMalesWithDependent = columnsLabourSupplyUtilityMalesWithDependent == -1? 8: columnsLabourSupplyUtilityMalesWithDependent ;
            columnsLabourSupplyUtilityFemalesWithDependent = columnsLabourSupplyUtilityFemalesWithDependent == -1? 8: columnsLabourSupplyUtilityFemalesWithDependent ;
            columnsLabourSupplyUtilityACMales = columnsLabourSupplyUtilityACMales == -1? 19: columnsLabourSupplyUtilityACMales ;
            columnsLabourSupplyUtilityACFemales = columnsLabourSupplyUtilityACFemales == -1? 19: columnsLabourSupplyUtilityACFemales ;
            columnsLabourSupplyUtilityCouples = columnsLabourSupplyUtilityCouples == -1? 93: columnsLabourSupplyUtilityCouples ;
            columnsLabourCovid19_SE = columnsLabourCovid19_SE == -1? 1: columnsLabourCovid19_SE ;
            columnsLabourCovid19_2a_processes = columnsLabourCovid19_2a_processes == -1? 1: columnsLabourCovid19_2a_processes ;
            columnsHealthH1a = columnsHealthH1a == -1? 28: columnsHealthH1a ;
            columnsHealthH1b = columnsHealthH1b == -1? 35: columnsHealthH1b ;
            columnsHealthH2b = columnsHealthH2b == -1? 35: columnsHealthH2b ;
            columnsHealthHM1 = columnsHealthHM1 == -1? 43: columnsHealthHM1 ;
            columnsHealthHM2Males = columnsHealthHM2Males == -1? 15: columnsHealthHM2Males ;
            columnsHealthHM2Females = columnsHealthHM2Females == -1? 15: columnsHealthHM2Females ;
            columnsHealthMCS1 = columnsHealthMCS1 == -1? 43: columnsHealthMCS1 ;
            columnsHealthMCS2Males = columnsHealthMCS2Males == -1? 15: columnsHealthMCS2Males ;
            columnsHealthMCS2Females = columnsHealthMCS2Females == -1? 15: columnsHealthMCS2Females ;
            columnsHealthPCS1 = columnsHealthPCS1 == -1? 43: columnsHealthPCS1 ;
            columnsHealthPCS2Males = columnsHealthPCS2Males == -1? 15: columnsHealthPCS2Males ;
            columnsHealthPCS2Females = columnsHealthPCS2Females == -1? 15: columnsHealthPCS2Females ;
            columnsLifeSatisfaction1 = columnsLifeSatisfaction1 == -1? 43: columnsLifeSatisfaction1 ;
            columnsLifeSatisfaction2Males = columnsLifeSatisfaction2Males == -1? 15: columnsLifeSatisfaction2Males ;
            columnsLifeSatisfaction2Females = columnsLifeSatisfaction2Females == -1? 15: columnsLifeSatisfaction2Females ;
            columnsHealthEQ5D = columnsHealthEQ5D == -1? 8: columnsHealthEQ5D ;
            columnsSocialCareS1a = columnsSocialCareS1a == -1? 17: columnsSocialCareS1a ;
            columnsSocialCareS1b = columnsSocialCareS1b == -1? 18: columnsSocialCareS1b ;
            columnsSocialCareS2a = columnsSocialCareS2a == -1? 32: columnsSocialCareS2a ;
            columnsSocialCareS2b = columnsSocialCareS2b == -1? 32: columnsSocialCareS2b ;
            columnsSocialCareS2c = columnsSocialCareS2c == -1? 39: columnsSocialCareS2c ;
            columnsSocialCareS2d = columnsSocialCareS2d == -1? 17: columnsSocialCareS2d ;
            columnsSocialCareS2e = columnsSocialCareS2e == -1? 16: columnsSocialCareS2e ;
            columnsSocialCareS2f = columnsSocialCareS2f == -1? 36: columnsSocialCareS2f ;
            columnsSocialCareS2g = columnsSocialCareS2g == -1? 21: columnsSocialCareS2g ;
            columnsSocialCareS2h = columnsSocialCareS2h == -1? 21: columnsSocialCareS2h ;
            columnsSocialCareS2i = columnsSocialCareS2i == -1? 21: columnsSocialCareS2i ;
            columnsSocialCareS2j = columnsSocialCareS2j == -1? 21: columnsSocialCareS2j ;
            columnsSocialCareS2k = columnsSocialCareS2k == -1? 18: columnsSocialCareS2k ;
            columnsSocialCareS3a = columnsSocialCareS3a == -1? 36: columnsSocialCareS3a ;
            columnsSocialCareS3b = columnsSocialCareS3b == -1? 38: columnsSocialCareS3b ;
            columnsSocialCareS3c = columnsSocialCareS3c == -1? 37: columnsSocialCareS3c ;
            columnsSocialCareS3d = columnsSocialCareS3d == -1? 79: columnsSocialCareS3d ;
            columnsSocialCareS3e = columnsSocialCareS3e == -1? 37: columnsSocialCareS3e ;
            columnsUnemploymentU1a = columnsUnemploymentU1a == -1? 19: columnsUnemploymentU1a ;
            columnsUnemploymentU1b = columnsUnemploymentU1b == -1? 19: columnsUnemploymentU1b ;
            columnsUnemploymentU1c = columnsUnemploymentU1c == -1? 19: columnsUnemploymentU1c ;
            columnsUnemploymentU1d = columnsUnemploymentU1d == -1? 19: columnsUnemploymentU1d ;
            columnsFinancialDistress = columnsFinancialDistress == -1? 50: columnsFinancialDistress ;
            columnsEducationE1a = columnsEducationE1a == -1? 19: columnsEducationE1a ;
            columnsEducationE1b = columnsEducationE1b == -1? 25: columnsEducationE1b ;
            columnsEducationE2a = columnsEducationE2a == -1? 11: columnsEducationE2a ;
            columnsPartnershipU1a = columnsPartnershipU1a == -1? 27: columnsPartnershipU1a ;
            columnsPartnershipU1b = columnsPartnershipU1b == -1? 31: columnsPartnershipU1b ;
            columnsPartnershipU2b = columnsPartnershipU2b == -1? 38: columnsPartnershipU2b ;
            columnsFertilityF1a = columnsFertilityF1a == -1? 6: columnsFertilityF1a ;
            columnsFertilityF1b = columnsFertilityF1b == -1? 26: columnsFertilityF1b ;
            columnsIncomeI1a = columnsIncomeI1a == -1? 19 : columnsIncomeI1a;
            columnsIncomeI1b = columnsIncomeI1b == -1? 31 : columnsIncomeI1b;
            columnsIncomeI3a = columnsIncomeI3a == -1? 20 : columnsIncomeI3a;
            columnsIncomeI3b = columnsIncomeI3b == -1? 29 : columnsIncomeI3b;
            columnsIncomeI3c = columnsIncomeI3c == -1? 28 : columnsIncomeI3c;
            columnsIncomeI4a = columnsIncomeI4a == -1? 24 : columnsIncomeI4a;
            columnsIncomeI4b = columnsIncomeI4b == -1? 25 : columnsIncomeI4b;
            columnsIncomeI5a = columnsIncomeI5a == -1? 25 : columnsIncomeI5a;
            columnsIncomeI5b = columnsIncomeI5b == -1? 25 : columnsIncomeI5b;
            columnsIncomeI6a = columnsIncomeI6a == -1? 22 : columnsIncomeI6a;
            columnsIncomeI6b = columnsIncomeI6b == -1? 22 : columnsIncomeI6b;
            columnsIncomeI3a_selection = columnsIncomeI3a_selection == -1? 20: columnsIncomeI3a_selection ;
            columnsIncomeI3b_selection = columnsIncomeI3b_selection == -1? 29: columnsIncomeI3b_selection ;
            columnsLeaveHomeP1a = columnsLeaveHomeP1a == -1? 25: columnsLeaveHomeP1a ;
            columnsHomeownership = columnsHomeownership == -1? 33: columnsHomeownership ;
            columnsRetirementR1a = columnsRetirementR1a == -1? 26: columnsRetirementR1a ;
            columnsRetirementR1b = columnsRetirementR1b == -1? 31: columnsRetirementR1b ;
            columnsChildcareC1a = columnsChildcareC1a == -1? 37: columnsChildcareC1a ;
            columnsChildcareC1b = columnsChildcareC1b == -1? 37: columnsChildcareC1b ;
            columnsValidationStudentsByAge = columnsValidationStudentsByAge == -1? 10: columnsValidationStudentsByAge ;
            columnsValidationStudentsByRegion = columnsValidationStudentsByRegion == -1? 13: columnsValidationStudentsByRegion ;
            columnsValidationEducationLevel = columnsValidationEducationLevel == -1? 3: columnsValidationEducationLevel ;
            columnsValidationEducationLevelByAge = columnsValidationEducationLevelByAge == -1? 24: columnsValidationEducationLevelByAge ;
            columnsValidationEducationLevelByRegion = columnsValidationEducationLevelByRegion == -1? 36: columnsValidationEducationLevelByRegion ;
            columnsValidationPartneredBUShareByRegion = columnsValidationPartneredBUShareByRegion == -1? 13: columnsValidationPartneredBUShareByRegion ;
            columnsValidationDisabledByGender = columnsValidationDisabledByGender == -1? 2: columnsValidationDisabledByGender ;
            columnsValidationDisabledByAgeGroup = columnsValidationDisabledByAgeGroup == -1? 6: columnsValidationDisabledByAgeGroup ;
            columnsValidationHealthByAgeGroup = columnsValidationHealthByAgeGroup == -1? 6: columnsValidationHealthByAgeGroup ;
            columnsValidationMentalHealthByAgeGroup = columnsValidationMentalHealthByAgeGroup == -1? 18: columnsValidationMentalHealthByAgeGroup ;
            columnsValidationHealthMCSByAgeGroup = columnsValidationHealthMCSByAgeGroup == -1? 18: columnsValidationHealthMCSByAgeGroup ;
            columnsValidationPhysicalHealthByAgeGroup = columnsValidationPhysicalHealthByAgeGroup == -1? 18: columnsValidationPhysicalHealthByAgeGroup ;
            columnsValidationLifeSatisfactionByAgeGroup = columnsValidationLifeSatisfactionByAgeGroup == -1? 18: columnsValidationLifeSatisfactionByAgeGroup ;
            columnsValidationEmploymentByGender = columnsValidationEmploymentByGender == -1? 2: columnsValidationEmploymentByGender ;
            columnsValidationEmploymentByGenderAndAge = columnsValidationEmploymentByGenderAndAge == -1? 18: columnsValidationEmploymentByGenderAndAge ;
            columnsValidationEmploymentByMaternity = columnsValidationEmploymentByMaternity == -1? 3: columnsValidationEmploymentByMaternity ;
            columnsValidationEmploymentByGenderAndRegion = columnsValidationEmploymentByGenderAndRegion == -1? 24: columnsValidationEmploymentByGenderAndRegion ;
            columnsValidationActivityStatus = columnsValidationActivityStatus == -1? 3: columnsValidationActivityStatus ;
            columnsValidationHomeownership = columnsValidationHomeownership == -1? 1: columnsValidationHomeownership ;
            columnsValidationLabourSupplyByEducation = columnsValidationLabourSupplyByEducation == -1? 3: columnsValidationLabourSupplyByEducation ;
            columnsValidationByGenderAndEducation = columnsValidationByGenderAndEducation == -1? 6: columnsValidationByGenderAndEducation ;
        }
