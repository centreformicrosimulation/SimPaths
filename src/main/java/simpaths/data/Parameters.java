...
public class Parameters {
    ...
    public static int MAX_NEIGHBOURS_IN_MATCHING = 1; // Specifies the maximum number of nearest neighbours used in matching
    ...
    public static final int MAX_LABOUR_HOURS_IN_WEEK = 96;
