...
public class CESUtility implements IEvaluation {
    ...
    public static final double ALPHA_YOUNG = 1.16;                                   // utility price of leisure for single adults
    public static final double ALPHA_MID = 1.16;                                     // utility price of leisure for single adults
    public static final double ALPHA_OLD = 1.16;                                     // utility price of leisure for couples
    public static final double GAMMA = 2.4;                                         // (constant) coefficient of risk aversion equal to inverse of intertemporal elasticity
