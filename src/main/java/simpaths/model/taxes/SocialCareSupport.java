...
public class SocialCareSupport {
    ...
    public SocialCareSupport(){}
    public SocialCareSupport(int year, boolean flagCouple, boolean flagSPA, double socialCareCostPerMonth, double disposableIncomePerMonth, double liquidWealth) {
