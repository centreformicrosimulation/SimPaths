...
- UK formation uses `Parameters.getRegPartnershipU1a()` with `score + probitAdjustment`; UK dissolution uses `Parameters.getRegPartnershipU2()` with `score - probitAdjustment`.
