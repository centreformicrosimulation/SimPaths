...
For building and running SimPaths, see the [root README](../README.md). For the full model documentation, see the [website](https://centreformicrosimulation.github.io/SimPaths/).
