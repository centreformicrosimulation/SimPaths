...
(line ded stm if dgn == 0, sort color(green) color(green%20) ///
	lpattern(dash) legend(label(2 "UKHLS"))), ///
...
twoway (histogram edu_pred if in_sample == 1, color(green)) ///
	...
	legend(lab(1 "Predicted") lab( 2 "UKHLS")) name(levels, replace) ///
...
(line edu_low stm, sort  color(red%20) ///
	lpattern(dash) legend(label(2 "Low education, UKHLS"))) ///
(line pred_edu_med stm, sort color(blue) ///
	legend(label(3 "Medium education, predicted"))) ///
(line edu_med stm, sort  color(blue%20) ///
	lpattern(dash) legend(label(4 "Medium education, UKHLS"))) ///
(line pred_edu_high stm, sort color(green) ///
	legend(label(5 "High education, predicted"))) ///
(line edu_high stm, sort  color(green%20) ///
	lpattern(dash) legend(label(6 "High education, UKHLS"))) , ///
 title("Educational Attainment when Leave Initial Education Spell") ///
	subtitle("Ages 16-29" ) ///
	xtitle("Year") ///
	ytitle("") ///
...
(line pred_edu_low stm if dgn == 0, sort color(red) ///
	legend(label(1 "Low education, predicted"))) ///
(line edu_low stm if dgn == 0, sort  color(red%20) ///
	lpattern(dash) legend(label(2 "Low education, UKHLS"))) ///
(line pred_edu_med stm if dgn == 0, sort color(blue) ///
	legend(label(3 "Medium education, predicted"))) ///
(line edu_med stm if dgn == 0, sort  color(blue%20) ///
	lpattern(dash) legend(label(4 "Medium education, UKHLS"))) ///
(line pred_edu_high stm if dgn == 0, sort color(green) ///
	legend(label(5 "High education, predicted"))) ///
(line edu_high stm if dgn == 0, sort color(green%20) ///
	lpattern(dash) legend(label(6 "High education, UKHLS"))) , ///
...
(line pred_edu_low stm if dgn == 1, sort color(red) ///
	legend(label(1 "Low education, predicted"))) ///
(line edu_low stm if dgn == 1, sort  color(red%20) ///
	lpattern(dash) legend(label(2 "Low education, UKHLS"))) ///
(line pred_edu_med stm if dgn == 1, sort color(blue) ///
	legend(label(3 "Medium education, predicted"))) ///
(line edu_med stm if dgn == 1, sort  color(blue%20) ///
	lpattern(dash) legend(label(4 "Medium education, UKHLS"))) ///
(line pred_edu_high stm if dgn == 1, sort color(green) ///
	legend(label(5 "High education, predicted"))) ///
(line edu_high stm if dgn == 1, sort color(green%20) ///
	lpattern(dash) legend(label(6 "High education, UKHLS"))) , ///
...
(line pred_edu_low stm if ydses_c5 == 1, sort color(red) ///
	legend(label(1 "Low education, predicted"))) ///
(line edu_low stm if ydses_c5 == 1, sort  color(red%20) ///
	lpattern(dash) legend(label(2 "Low education, UKHLS"))) ///
(line pred_edu_med stm if ydses_c5 == 1, sort color(blue) ///
	legend(label(3 "Medium education, predictedd"))) ///
(line edu_med stm if ydses_c5 == 1, sort  color(blue%20) ///
	lpattern(dash) legend(label(4 "Medium education, UKHLS")))	///
(line pred_edu_high stm if ydses_c5 == 1, sort color(green) ///
	legend(label(5 "High education, predicted"))) ///
(line edu_high stm if ydses_c5 == 1, sort  color(green%20) ///
	lpattern(dash) legend(label(6 "HIgh education, UKHLS"))), ///
name(graph1) title("First quintile") xtitle("Year") ytitle("") ///
	xlabel(, labsize(small)) ylabel(, labsize(small)) ///
	legend(size(small)) ///
...
(line pred_edu_low stm if ydses_c5 == 3, sort color(red) ///
	legend(label(1 "L Pred"))) ///
(line edu_low stm if ydses_c5 == 3, sort  color(red%20) ///
	lpattern(dash) legend(label(2 "L Obs"))) ///
(line pred_edu_med stm if ydses_c5 == 3, sort color(blue) ///
	legend(label(3 "M Pred"))) ///
(line edu_med stm if ydses_c5 == 3, sort  color(blue%20) ///
	lpattern(dash) legend(label(4 "M Obs")))	///
(line pred_edu_high stm if ydses_c5 == 3, sort color(green) ///
	legend(label(5 "H Pred"))) ///
(line edu_high stm if ydses_c5 == 3, sort  color(green%20) ///
	lpattern(dash) legend(label(6 "H Obs"))), ///
name(graph3) title("Third quintile") xtitle("Year") ytitle("") ///
	xlabel(, labsize(small)) ylabel(, labsize(small)) ///
	legend(size(small)) ///
...
(line pred_edu_low stm if ydses_c5 == 4, sort color(red) ///
	legend(label(1 "L Pred"))) ///
(line edu_low stm if ydses_c5 == 4, sort  color(red%20) ///
	lpattern(dash) legend(label(2 "L Obs"))) ///
(line pred_edu_med stm if ydses_c5 == 4, sort color(blue) ///
	legend(label(3 "M Pred"))) ///
(line edu_med stm if ydses_c5 == 4, sort color(blue%20) ///
	lpattern(dash) legend(label(4 "M Obs")))	///
(line pred_edu_high stm if ydses_c5 == 4, sort color(green) ///
	legend(label(5 "H Pred"))) ///
(line edu_high stm if ydses_c5 == 4, sort  color(green%20) ///
	lpattern(dash) legend(label(6 "H Obs"))), ///
name(graph4) title("Fourth quintile") xtitle("Year") ytitle("") ///
	xlabel(, labsize(small)) ylabel(, labsize(small)) ///
	legend(size(small)) ///
...
(line pred_edu_low stm if ydses_c5 == 5, sort color(red) ///
	legend(label(1 "L Pred"))) ///
(line edu_low stm if ydses_c5 == 5, sort  color(red%20) ///
	lpattern(dash) legend(label(2 "L Obs"))) ///
(line pred_edu_med stm if ydses_c5 == 5, sort color(blue) ///
	legend(label(3 "M Pred"))) ///
(line edu_med stm if ydses_c5 == 5, sort color(blue%20) ///
	lpattern(dash) legend(label(4 "M Obs")))	///
(line pred_edu_high stm if ydses_c5 == 5, sort color(green) ///
	legend(label(5 "H Pred"))) ///
(line edu_high stm if ydses_c5 == 5, sort  color(green%20) ///
	lpattern(dash) legend(label(6 "H Obs"))), ///
name(graph5) title("Fifth quintile") xtitle("Year") ytitle("") ///
	xlabel(, labsize(small)) ylabel(, labsize(small)) ///
	legend(size(small)) ///
