...
* load pooled data with missing values removed  
	...
	*limit saved variables
	...
	disp_inc ypncp ypnoab aidhrs carewho dhe_mcs dhe_pcs dls dot unemp financial_distress
	...
	potential_earnings_hourly l1_potential_earnings_hourly liquid_wealth tot_pen nvmhome need_socare formal_socare_hrs partner_socare_hrs ///
	daughter_socare_hrs son_socare_hrs other_socare_hrs formal_socare_cost econ_benefits econ_benefits_nonuc econ_benefits_uc ///
	disp_inc ypncp ypnoab aidhrs carewho dhe_mcs dhe_pcs dls dot unemp financial_distress (missing=-9)
