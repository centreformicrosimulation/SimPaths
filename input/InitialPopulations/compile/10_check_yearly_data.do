...
foreach var in  need_socare  formal_socare_hrs  partner_socare_hrs daughter_socare_hrs son_socare_hrs other_socare_hrs  formal_socare_cost liquid_wealth carehoursprovidedweekly {
recode `var' (.=0)
}
...
liquid_wealth carehoursprovidedweekly {
recode `var' (.=0)
}
